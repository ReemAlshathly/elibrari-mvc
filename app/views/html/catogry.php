        ...
        <div style="display: flex; width: 80vw">
          ...
          <div class="search">
            <form>
              ...
              <input  class="search-head" class="search-head" onkeyup="search_animal()" 
  ...
  <!-- The dots/circles -->
    ...
    <div class="main">
        ...
        <div class="cat-rigth">
            ...
            <div class="cat-rigth-book">
                <p style="color: rgb(5, 46, 19);"> كتب الكترونية</p>
            </div>
            <div class="cat-rigth-result">
                <div class="cat-rigth-result-filter">
                    <p > تصفية النتائج </p>
            </div>
            <div class="cat-rigth-result-filter-price">
                <p > علامة تجارية  </p>
            </div>
            <div class="cat-rigth-result-filter-price">
                <p >  السعر </p>
        ...
        <div class="left">
            <div class="order">
               <input type="text"  placeholder="الرجاء الاختيار "  style="width: 30%;">
            </div>
            <section class="show-now1" id="list">
                <div class="books">
