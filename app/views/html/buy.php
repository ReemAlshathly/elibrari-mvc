...
<body>
  ...
  <div class="head-buy"> 
    <h1>اكمل الخطوات التالية </h1>
  </div>
  <section>
   
    
    <div class="sli-book" id="sli-book">
    <div class="container">
        <div class="progress">
    ...
    <div class="container-btn">
        ...
        <div id="myModal" class="modal-basket">

            <!-- Modal content -->
            <div class="modal-content-basket">
              <span class="close" ><a href="../html/buy.html">&times;</a></span>
              <div class="form">
                  <input type="text" placeholder="اسم المستخدم"><br>
                  <input type="text" placeholder="المدينة">
                <div class="first-form">
                    <button id="next-btn2" class="bt-book">التالي</button>
                    <button id="prev-btn2" class="bt-book">السابق</button>  
                </div>
              </div>
            </div>
            ...
            <div id="myModal2" class="modal-basket2">

            <!-- Modal content -->
            <div class="modal-content-basket">
                <span class="close"><a href="../html/buy.html">&times;</a></span>
                <div class="form">
                    <input type="text" placeholder="رقم الهاتف"><br>
                    <input type="text" placeholder="رقم الهوية">
                  <div class="first-form">
                      <button id="next-btn3" class="bt-book">التالي</button>
                      <button id="prev-btn3" class="bt-book">السابق</button>  
                  </div>
                </div>
              </div>
            ...
            <div id="myModal3" class="modal-basket3">

                <!-- Modal content -->
                <div class="modal-content-basket">
                    <span class="close"><a href="../html/buy.html">&times;</a></span>
                    <div class="form">
                        <input type="text" placeholder=" البريد الالكتروني"><br>
                        <input type="text" placeholder="  كلمة المرور">
                      <div class="first-form">
                          <button id="next-btn4" class="bt-book">التالي</button>
                          <button id="prev-btn4" class="bt-book">السابق</button>  
                      </div>
                    </div>
                  </div>
                
                </div>
                <div id="myModal4" class="modal-basket4">
                    ...
                    <div class="modal-content-basket">
                        ...
                        <div class="form">
                           <div class="final">
                            <h1 >   اضافة الى السلة  ؟ </h1> 
                           </div>
                          <div class="first-form">
                              <button id="next-btn5" class="bt-book" >موافق</button>
                              <button id="prev-btn5" class="bt-book" >رجوع</button>
                          </div>
                        </div>
                      </div>
                    
                    </div>
                    <div id="myModal5" class="modal-basket5">
                      ...
                      <div class="modal-content-basket">
                          ...
                          <div class="form">
                            ...
                            <div class="first-form">
                               <a href="../html/index.html"> <button  class="bt-book" href="">موافق</button></a>
          ...
          <div class="bt-div">
        <button id="next-btn" class="bt-book2">التالي</button>
      <a href="../html/basket.html"> <button id="prev-btn" class="bt-book2">السابق</button> </a> 
    </div>  
